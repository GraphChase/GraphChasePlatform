...
class RHMAPPO:
    ...
    def ppo_update(self, sample, update_actor=True):
        if self.args.use_end_to_end:
            hgs_batch, Ts_batch, share_obs_batch, obs_batch, action_masks_batch, actions_batch, value_preds_batch, \
            ...
            pooled_node_embs_batch, Ts_batch, share_obs_batch, obs_batch, action_masks_batch, actions_batch, value_preds_batch, \
                return_batch, masks_batch, old_action_log_probs_batch, adv_targ, demo_act_probs_batch = sample
            values, action_log_probs, dist_entropy, log_probs = self.policy.evaluate_actions(
        ...
        # values, action_log_probs, dist_entropy, log_probs = self.policy.evaluate_actions(pooled_node_embs_batch, Ts_batch, share_obs_batch, obs_batch, actions_batch, batch=True)
