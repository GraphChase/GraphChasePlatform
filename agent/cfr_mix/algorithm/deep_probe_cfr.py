...
from agent.cfr_mix.player_class.deep_defender_class import Defender
from agent.cfr_mix.traverse_methods.deep_probe_cfr import probe_traverse_tree
from agent.cfr_mix.evaluation.deep_worst_case_utility import evaluation_deep_cfr


def deep_probe_cfr(game_graph, init_location, time_horizon, network_dim, sample_number, action_number, attacker_regret_batch_size,
